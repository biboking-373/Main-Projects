<script>
  ...
  import { employeeBookingsAPI } from '../../lib/employeeAPI';
  ...
  async function openDetailModal(booking) {
    ...
    newStatus = booking.booking_status || booking.status;
  ...
  async function updateBookingStatus() {
    ...
    try {
      error = null;
      await employeeBookingsAPI.updateStatus(selectedBooking.id, newStatus);
      closeDetailModal();
      await loadBookings();
    } catch (err) {
...
<div class="container">
  <div class="header">
    ...
    <p>Manage customer bookings and reservations</p>
  </div>
          ...
          <tbody>
            {#each bookings as booking}
              <tr on:click={() => openDetailModal(booking)}>
                ...
                <td>
                  <span class="status-badge {getStatusColor(booking.booking_status || booking.status)}">
        ...
        <div class="info-section">
          ...
          <div class="info-grid">
            ...
            <div>
              ...
              <p class="info-value">{formatDate(selectedBooking.check_in_date || selectedBooking.check_in)}</p>
            </div>
            <div>
              <p class="info-label">Check Out</p>
              <p class="info-value">{formatDate(selectedBooking.check_out_date || selectedBooking.check_out)}</p>
            </div>
            <div>
              <p class="info-label">Number of Nights</p>
              <p class="info-value">
                {calculateNights(selectedBooking.check_in_date || selectedBooking.check_in, selectedBooking.check_out_date || selectedBooking.check_out)}
              </p>
            </div>
            <div>
